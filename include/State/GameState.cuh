...
enum CarInternalField
{
    CAR_INT_ON_GROUND,
    CAR_INT_AIR_TIME_SINCE_JUMP,
    CAR_INT_HANDBRAKE,
    CAR_INT_HAS_JUMPED,
    CAR_INT_IS_JUMPING,
    CAR_INT_LAST_JUMP,
    CAR_INT_JUMP_TIME,
    CAR_INT_HAS_DOUBLE_JUMPED,
    CAR_INT_HAS_FLIPPED,
    CAR_INT_IS_FLIPPING,
    CAR_INT_FLIP_TIME,
    CAR_INT_IS_AUTO_FLIPPING,
    CAR_INT_AUTO_FLIP_TIMER,
    CAR_INT_AUTO_FLIP_TORQUE_SCALE,
    CAR_INT_FLIP_TORQUE_X,
    CAR_INT_FLIP_TORQUE_Y,
    CAR_INT_FLIP_TORQUE_Z,
    CAR_INT_IS_BOOSTING,
    CAR_INT_BOOSTING_TIME,
    CAR_INTERNAL_SIZE
};
